...
const compileSass = (done) => {
  ...
  src("./src/scss/**/*.scss", { sourcemaps: true })
    ...
    .pipe(postcss(postcssPlugins)) // ここで使う
...
const browserReload = (done) => {
  ...
  const tinyPng = done => {
    src("./src/img/**/*.{png,jpg,jpeg}")
      ...
      .pipe(
        tinypng({
          key: "WzGJBVXrRsKz5qjz76814ZQ863tqp9KQ",
...
module.exports = {
  ...
  cache: cacheBusting,
  build: series(parallel(compileSass, bundleJs), tinyPng, copyImages, generateWebp, cacheBusting),
